...
""")
                os.system(f"screen node ./data/fart.js {url} 40 {time}")
                os.system(f"screen perl ./data/tls.pl {url} 40 {time}")
            except IndexError:
                print("Usage : tls <url> <port> <time>")
                print("Example : tls https://vudunganh.tk 443 60")
